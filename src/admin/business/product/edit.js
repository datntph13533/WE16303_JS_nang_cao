                                ...
                                <div class="shadow sm:rounded-md sm:overflow-hidden">
                                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input type="text" id="price-product" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm h-[30px] border border-gray-300 rounded-md pl-[10px]" value="${data.price}">
                                        </div>
                                        <div class="col-span-6">
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <textarea  rows="5" id="desc-product" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md pl-[10px]">${data.desc}</textarea>
                                            </div>
                                        </div>
                                        <div>
