                            ...
                            <form id="formEdit">
                                <div class="shadow sm:rounded-md sm:overflow-hidden">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input type="text" id="title-post" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm h-[30px] border border-gray-300 rounded-md pl-[10px]" value="${data.title}">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Nội dung <span class="text-[red]">*</span></label>
                                        <div class="mt-1">
                                            <textarea  rows="5" id="desc-post" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md pl-[10px]">${data.desc}</textarea>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        </div><input type="hidden" name="oldImage" value="${data.image}">
                                        </div>
                                    </div>
                                    </div>
